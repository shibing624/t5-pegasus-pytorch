...
class CopyT5Predictor(object):
    ...
    def batch_predict(self, texts: List[str], max_length: int = 128, batch_size: int = 256, silent: bool = False):
        """
        预测
...
if __name__ == "__main__":
    m = CopyT5Predictor('saved/copyt5_correction')
    error_sentences = [
    ...
    t2 = time.time()
    res = m.batch_predict(error_sentences)
